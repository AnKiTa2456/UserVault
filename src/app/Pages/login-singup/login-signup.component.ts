...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule], // Must include CommonModule here
  templateUrl: './login-signup.component.html',  // make sure this file exists with this exact name
...
export class LoginSignupComponent {
  ...
  registerForm() {
    ...
    if (!emailRegex.test(email)) {
      ...
      return;  // <-- fixed missing semicolon and return statement here
    }
